                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form wire:submit="save">
                        ...
                        <div class="mt-4">
                            ...
                            <div wire:ignore>
                                <textarea wire:model="description" data-description="@this" id="description"
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input wire:model="price" type="number" min="0" step="0.01"
                        ...
                        <div class="mt-4">
                            ...
                            <x-select2 class="mt-1" id="country" name="country" :options="$this->listsForFields['countries']"
                                wire:model="country_id" :multiple/>
